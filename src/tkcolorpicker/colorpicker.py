...
#        self.value = tk.StringVar(self)
        ...
        ttk.Label(hsv_frame, text='Hue').grid(row=0, column=0, sticky='e',
                                                 padx=4, pady=4)
        ttk.Label(hsv_frame, text='Saturation').grid(row=1, column=0, sticky='e',
                                                        padx=4, pady=4)
        ttk.Label(hsv_frame, text='Value').grid(row=2, column=0, sticky='e',
                                                   padx=4, pady=4)
...
#        self.blue = tk.StringVar(self)
        ...
        ttk.Label(rgb_frame, text='Red').grid(row=0, column=0, sticky='e',
                                                 padx=4, pady=4)
        ttk.Label(rgb_frame, text='Green').grid(row=1, column=0, sticky='e',
                                                   padx=4, pady=4)
        ttk.Label(rgb_frame, text='Blue').grid(row=2, column=0, sticky='e',
                                                  padx=4, pady=4)
        # --- hexa
        #supposed to show hex of the color?
        ...
        ttk.Label(hexa_frame, text="Hex: ").pack(side="left", padx=4, pady=(4, 1))
...
#            self.alpha = tk.StringVar(self)
            ...
            ttk.Label(alpha_frame, text='Alpha').grid(row=0, column=1, sticky='e',
                                                         padx=4, pady=4)
            s_alpha.grid(row=0, column=2, sticky='w', padx=(4, 6), pady=4)

        # --- validation
        button_frame = ttk.Frame(self)
        canclbtn = ttk.Button(button_frame, text="Cancel",
                   command=self.destroy).pack(side="right", padx=10)
        test = ttk.Button(button_frame, text="Select", command=self.ok).pack(side = "left", padx = 10)
...
def askcolor(color="red", parent=None, title="Color Chooser", alpha=True):
    """

...
Look into: dataclass-type-validator, marshmallow-dataclass, dataclasses-json
"""
...
# from pydantic.dataclasses import dataclass  # breaks pylance :(
...
class WaterAbsFitParams():
    ...
    def as_tuple(self) -> Tuple[ParamsNTup, ErrType]:
        ...
        t = cast(Tuple[ParamsNTup, ErrType], astuple(self))
        return t
...
t = WaterAbsFitParams(init_params=(1, 2, 3, 4))
dic = t.as_dict()
a = len(t.as_tuple())
at = t.as_tuple()
print(at)

...
sp = Path(R".\results")
oxalate_plot_500 = plot_multi(input=oxal_data_500, save_path=sp,
                              file_name="plot_oxalate.png", fix_n=False, vmax_line=False)
oxalate_bet_500 = plot_bet_multi(input=oxal_data_500, save_path=sp, file_name="bet_oxalate.png", y_max=1e13)
oxalate_plot_500 = plot_multi(input=oxal_data_500, save_path=sp,
                              file_name="plot_oxalate_fix.png", fix_n=True, vmax_line=False)
